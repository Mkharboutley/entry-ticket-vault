    ...
    <section className="py-16 relative z-10">
      <div className="container mx-auto px-4">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {winners.map((winner, index) => (
              <Card key={winner.id || index} className="bg-white/15 backdrop-blur-xl border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:bg-white/20 hover:-translate-y-2">
                <CardHeader className="text-center pb-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-2xl backdrop-blur-xl">
                    <Trophy className="w-8 h-8 text-white drop-shadow-lg" />
                  </div>
                  <CardTitle className="text-xl font-bold text-white drop-shadow-lg">
                    {winner.prize_name}
                  </CardTitle>
                  <Badge className="bg-green-500/20 backdrop-blur-xl text-green-300 border border-green-400/30 shadow-lg">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="bg-white/15 backdrop-blur-xl rounded-lg p-3 border border-white/20 shadow-lg">
        ...
        <div className="text-center mt-8">
          <button className="text-yellow-300 hover:text-yellow-200 font-semibold transition-colors drop-shadow-lg">
